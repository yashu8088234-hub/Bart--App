...
with grid_left:
    ...
    st.markdown("<p style='font-size: 20px; font-weight: 700; color: #1E293B;margin-top:-80px ; margin-bottom: -10px;'>Staff Control</p>", unsafe_allow_html=True)
...
with grid_right:
    st.markdown('<div class="card-wrapper">', unsafe_allow_html=True)
    st.markdown("<p style='font-size: 20px; font-weight: 700; color: #1E293B;margin-top:-80px ; margin-bottom: -10px;'>HQ Administration</p>", unsafe_allow_html=True)
