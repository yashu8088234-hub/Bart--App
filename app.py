...
with grid_left:
    st.markdown('<div class="card-glow"><div class="card-content"><p style='font-size: 20px;text-align: center; font-weight: 700; color: #1E293B;'>Staff Control</p>', unsafe_allow_html=True)
