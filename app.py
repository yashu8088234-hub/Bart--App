...
# =========================================================
# CSS ARCHITECTURE (MATCHING GREEN #2ED47A)
# =========================================================
st.markdown("""<style>
...
/* --- UPDATED BUTTON STYLE: SOLID MATCH --- */
div.stButton > button {
...
div.stButton > button[key="staff_btn"]:hover {
    ...
    background-color: #26B869 !important;
...
st.markdown(
    ...
    "Operations management <br><span style='color: #2ED47A;'>just got easier.</span>"
