...
.background-container {
    ...
    z-index: -9999; overflow: hidden; background: #FFFFFF;
}
.map-bg {
    position: absolute; width: 100%; height: 100%; opacity: 0.05;
    background-image: radial-gradient(#2ED47A 1px, transparent 1px);
    background-size: 50px 50px;
}
.orbit-wrap { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); }
.orbit {
    position: absolute; border: 1px solid rgba(46, 212, 122, 0.2);
...
.icon { animation: counter linear infinite; font-size: 20px; position: absolute; top: -12px; left: 50%; margin-left: -10px; }

/* 2. Streamlit Override */
.stApp, [data-testid="stAppViewContainer"] { background: transparent !important; }

/* 3. Original UI Elements */
...
.bart-logo { display: inline-block; animation: breathe-bold 2s ease-in-out infinite; background: linear-gradient(90deg, #2ED47A 0%, #20C997 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: 900 !important; letter-spacing: -2px; }
...
<div class="background-container">
    ...
    <div class="orbit-wrap">
        <div class="orbit" style="width: 300px; height: 300px; animation-duration: 20s;"><div class="icon" style="animation-duration: 20s;">🍴</div></div>
        <div class="orbit" style="width: 500px; height: 500px; animation-duration: 35s;"><div class="icon" style="animation-duration: 35s;">🔒</div></div>
        <div class="orbit" style="width: 700px; height: 700px; animation-duration: 50s;"><div class="icon" style="animation-duration: 50s;">📝</div></div>
    </div>
</div>
