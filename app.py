...
with grid_left:
    st.markdown("""<div class="card-glow"><div class="card-content" style="text-align: center; font-family: 'Times New Roman', Times, serif;margin-top: -10px;margin-bottom: -10px; color: #1E293B; font-size: 20px; font-weight: 700;">Staff""", unsafe_allow_html=True)
