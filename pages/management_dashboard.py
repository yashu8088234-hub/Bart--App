...
def fetch_sheet_range(
    ...
    try:
        ...
        if not ss:
            ...
            print(
                f"{branch_name}: Spreadsheet not found"
            )
        ...
        print(
            f"{branch_name}: LIVE DATA FETCHED"
        )
